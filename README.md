...
![image](https://user-images.githubusercontent.com/89846299/137726982-693ae41f-8920-4860-a64e-f6c0ef2f7cac.png)
###### ER-диаграмма
Ресурс является частью базы данных, которая относится к информационным потокам, и состоит из: Наименование ресурса, Количество, Дата и время <br/> 
